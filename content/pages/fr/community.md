...
Vous souhaitez aller plus loin avec Sozi ? Cette page vous donne accès au forum des utilisateurs de Sozi, au code source et liste plusieurs moyens de contribuer. 
Toutes les contributions sont les bienvenues.

## Forum des utilisateurs

> Le [forum des utilisateurs de Sozi](/community) est le meilleur entroit pour obtenir de l'aide dans l'utilisation de Sozi, poser des questions ou y répondre,
> échanger des astuces et des bonnes pratiques, et partager vos créations.


## Contribuer

Le code source de Sozi est disponible dans les dépôts suivants. N'hésitez pas à explorer&nbsp;:
...
Le respect de la vie privée est très important pour nous. Voici notre [politique de confidentialité](|filename|privacy.md).
